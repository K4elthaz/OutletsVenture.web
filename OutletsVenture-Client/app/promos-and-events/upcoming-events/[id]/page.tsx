          ...
          <div className="lg:flex">
            ...
            <div className="lg:w-1/2">
              <img
                src={event.photo}
                alt={event.title}
                className="object-cover w-full h-full" // Dynamic height for the image
              />
            </div>
            ...
            <div className="p-6 lg:w-1/2 flex flex-col justify-between">
              ...
              <div className="mb-2"> {/* Adjusted margin */}
                ...
                <p className="text-gray-600 mt-1">{event.description}</p> {/* Adjusted margin */}
              </div>

              {/* Date Section */}
              <div className="flex items-center text-gray-600 mt-1"> {/* Reduced margin */}
              ...
              <div className="mt-auto flex justify-end"> {/* Stick button to bottom */}
                <button
                  ...
                  onClick={() => router.back()} // Back button functionality added here
                >
                  <ArrowBackIcon className="mr-2" /> {/* Back icon added here */}
                  Back to Events
                </button>
              </div>
            </div>
